...
namespace Portal.Controllers
{
    ...
    public class ManageController : BaseController
    {
        ...
        public ManageController(PortalUserManager userManager, ApplicationSignInManager signInManager) : base(userManager,signInManager)
        {
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ...
            var model = new IndexViewModel
            {
                ...
                BrowserRemembered = await AuthenticationManager.TwoFactorBrowserRememberedAsync(userIdStr)
            };
            return View(model);
        }
