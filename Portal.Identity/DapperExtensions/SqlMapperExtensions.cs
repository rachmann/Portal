...
namespace Portal.Identity.DapperExtensions
{
    ...
    public static class SqlMapperExtensions
    {
            ...
            if (entityToInsert != null)
            {
                using (var tx = connection.BeginTransaction())
                {
                    ...
                    for (var i = 0; i < allPropertiesExceptKeyAndComputed.Count(); i++)
                    {
                        ...
                        // shouldn't need this because keys are already 'Excepted' above
                        //if (keyProperties.Contains(property)) continue;
                    ...
                    var id = connection.ExecuteScalar<long>(sb.ToString(), entityToInsert, transaction: transaction ?? tx, commandTimeout: commandTimeout);
                    if (transaction == null)
                        tx.Commit();
                    resultId = id;
                }
        ...
        public static bool Update<T>(this IDbConnection connection, T entityToUpdate, IDbTransaction transaction = null, int? commandTimeout = null) where T : class
        {
            ...
            if (entityToUpdate != null)
            {
                ...
                updated = connection.Execute(sb.ToString(), entityToUpdate, commandTimeout: commandTimeout, transaction: transaction);
            }
            return updated > 0;
        ...
        public static bool Delete<T>(this IDbConnection connection, T entityToDelete, IDbTransaction transaction = null, int? commandTimeout = null) where T : class
        {
            ...
            if (entityToDelete != null)
            {
                ...
                deleted = connection.Execute(sb.ToString(), entityToDelete, transaction: transaction, commandTimeout: commandTimeout);
            }
            return deleted > 0;
        }
        ...
        class ProxyGenerator
        {
            ...
            public static T GetInterfaceProxy<T>()
            {
                ...
                var interfaceType = typeof(DapperExtensions.SqlMapperExtensions.IProxy);
            ...
            private static MethodInfo CreateIsDirtyProperty(TypeBuilder typeBuilder)
            {
                ...
                var getMethod = typeof(DapperExtensions.SqlMapperExtensions.IProxy).GetMethod("get_" + "IsDirty");
                var setMethod = typeof(DapperExtensions.SqlMapperExtensions.IProxy).GetMethod("set_" + "IsDirty");
